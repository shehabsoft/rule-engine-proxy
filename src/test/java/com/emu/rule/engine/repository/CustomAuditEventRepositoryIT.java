package com.emu.rule.engine.repository;

import com.emu.rule.engine.RuleEngineApp;

import com.emu.rule.engine.config.Constants;
import com.emu.rule.engine.config.TestSecurityConfiguration;
import com.emu.rule.engine.config.audit.AuditEventConverter;
import com.emu.rule.engine.domain.PersistentAuditEvent;
...
import static com.emu.rule.engine.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
