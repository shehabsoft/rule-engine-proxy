...
@RestController
@RequestMapping("/api/rule-engine-proxy-kafka")
public class RuleEngineProxyKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RuleEngineProxyKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public RuleEngineProxyKafkaResource(KafkaProperties kafkaProperties) {
